...
// Ensure the first post has plenty of comments for workshop demos
MOCK_FEED[0].comments = [
  {
    id: "first-c1", username: "react_ninja", avatar: "https://i.pravatar.cc/150?img=4",
    text: "Amazing talk! Learned so much about performance! 🚀", likes: 142, timestamp: "2h",
    replies: [
      { id: "first-c1-r1", username: "expo_explorer", avatar: "https://i.pravatar.cc/150?img=3", text: "Same here, the profiler tips were gold", likes: 38, timestamp: "1h", replyingTo: "react_ninja", replies: [] },
      { id: "first-c1-r2", username: "perf_optimizer", avatar: "https://i.pravatar.cc/150?img=18", text: "Glad it resonated! I'll share the slides soon", likes: 67, timestamp: "45m", replyingTo: "react_ninja", replies: [], isCreatorReply: true },
    ],
    isPinned: true, sentiment: "positive", language: "en",
  },
  {
    id: "first-c2", username: "mobile_maestro", avatar: "https://i.pravatar.cc/150?img=6",
    text: "The memo vs useMemo comparison was super clear. Finally get it!", likes: 98, timestamp: "2h",
    replies: [
      { id: "first-c2-r1", username: "type_wizard", avatar: "https://i.pravatar.cc/150?img=11", text: "Right? I've been using memo wrong this whole time 😅", likes: 24, timestamp: "1h", replyingTo: "mobile_maestro", replies: [] },
    ],
    sentiment: "positive", language: "en",
  },
  {
    id: "first-c3", username: "async_adventurer", avatar: "https://i.pravatar.cc/150?img=7",
    text: "Can you share the slides from this talk?", likes: 45, timestamp: "1h",
    replies: [], sentiment: "neutral", language: "en",
  },
  {
    id: "first-c4", username: "stack_surfer", avatar: "https://i.pravatar.cc/150?img=8",
    text: "Kraków is beautiful, loving the venue!", likes: 73, timestamp: "3h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c5", username: "pixel_pusher", avatar: "https://i.pravatar.cc/150?img=9",
    text: "The Reanimated section was mind-blowing 🤯", likes: 112, timestamp: "2h",
    replies: [
      { id: "first-c5-r1", username: "animations_guru", avatar: "https://i.pravatar.cc/150?img=17", text: "Thanks! We have even more planned for v4", likes: 89, timestamp: "1h", replyingTo: "pixel_pusher", replies: [], isCreatorReply: true },
      { id: "first-c5-r2", username: "native_builder", avatar: "https://i.pravatar.cc/150?img=19", text: "v4 is going to be insane, can't wait", likes: 15, timestamp: "30m", replyingTo: "animations_guru", replies: [] },
    ],
    sentiment: "positive", language: "en",
  },
  {
    id: "first-c6", username: "bug_buster", avatar: "https://i.pravatar.cc/150?img=10",
    text: "Adding these techniques to my project ASAP", likes: 34, timestamp: "1h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c7", username: "speaker_circle", avatar: "https://i.pravatar.cc/150?img=12",
    text: "Best conference I've been to this year!", likes: 156, timestamp: "4h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c8", username: "rn_community", avatar: "https://i.pravatar.cc/150?img=14",
    text: "The community here is so welcoming!", likes: 67, timestamp: "3h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c9", username: "krakow_tech", avatar: "https://i.pravatar.cc/150?img=15",
    text: "Software Mansion really knows how to organize events!", likes: 88, timestamp: "5h",
    replies: [
      { id: "first-c9-r1", username: "code_craftsman", avatar: "https://i.pravatar.cc/150?img=2", text: "They've outdone themselves this year for sure", likes: 31, timestamp: "4h", replyingTo: "krakow_tech", replies: [] },
    ],
    sentiment: "positive", language: "en",
  },
  {
    id: "first-c10", username: "workshop_lead", avatar: "https://i.pravatar.cc/150?img=16",
    text: "Who's coming to the performance workshop tomorrow? 🙋", likes: 203, timestamp: "1h",
    replies: [
      { id: "first-c10-r1", username: "attendee_dev", avatar: "https://i.pravatar.cc/150?img=20", text: "Wouldn't miss it!", likes: 12, timestamp: "45m", replyingTo: "workshop_lead", replies: [] },
      { id: "first-c10-r2", username: "js_junkie", avatar: "https://i.pravatar.cc/150?img=21", text: "Already got my seat reserved 💪", likes: 8, timestamp: "30m", replyingTo: "workshop_lead", replies: [] },
      { id: "first-c10-r3", username: "mobile_maestro", avatar: "https://i.pravatar.cc/150?img=6", text: "Bringing my whole team!", likes: 19, timestamp: "20m", replyingTo: "workshop_lead", replies: [] },
    ],
    sentiment: "positive", language: "en",
  },
  {
    id: "first-c11", username: "js_junkie", avatar: "https://i.pravatar.cc/150?img=21",
    text: "The Expo Router talk changed how I think about navigation", likes: 54, timestamp: "2h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c12", username: "swift_sage", avatar: "https://i.pravatar.cc/150?img=22",
    text: "Coming from native iOS, I'm impressed by how far RN has come", likes: 77, timestamp: "3h",
    replies: [
      { id: "first-c12-r1", username: "kotlin_king", avatar: "https://i.pravatar.cc/150?img=23", text: "Same from Android side. The new arch is a game changer", likes: 42, timestamp: "2h", replyingTo: "swift_sage", replies: [] },
    ],
    sentiment: "positive", language: "en",
  },
  {
    id: "first-c13", username: "flutter_fan", avatar: "https://i.pravatar.cc/150?img=24",
    text: "Ok I have to admit this looks really good", likes: 63, timestamp: "1h",
    replies: [], sentiment: "neutral", language: "en",
  },
  {
    id: "first-c14", username: "web_warrior", avatar: "https://i.pravatar.cc/150?img=25",
    text: "Is there a way to watch the talks remotely?", likes: 29, timestamp: "4h",
    replies: [
      { id: "first-c14-r1", username: "appjs_conf", avatar: "https://i.pravatar.cc/150?img=1", text: "Recordings will be on YouTube in a few weeks!", likes: 156, timestamp: "3h", replyingTo: "web_warrior", replies: [], isCreatorReply: true },
    ],
    sentiment: "neutral", language: "en",
  },
  {
    id: "first-c15", username: "api_architect", avatar: "https://i.pravatar.cc/150?img=26",
    text: "The Server Components discussion was surprisingly relevant for mobile", likes: 41, timestamp: "2h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c16", username: "db_designer", avatar: "https://i.pravatar.cc/150?img=27",
    text: "Anyone else struggling with the wifi here? 😂", likes: 187, timestamp: "6h",
    replies: [
      { id: "first-c16-r1", username: "cloud_coder", avatar: "https://i.pravatar.cc/150?img=28", text: "Conference wifi never works, it's tradition 😄", likes: 93, timestamp: "5h", replyingTo: "db_designer", replies: [] },
      { id: "first-c16-r2", username: "devops_dude", avatar: "https://i.pravatar.cc/150?img=29", text: "Use mobile hotspot, saved my life", likes: 22, timestamp: "5h", replyingTo: "db_designer", replies: [] },
    ],
    sentiment: "neutral", language: "en",
  },
  {
    id: "first-c17", username: "cloud_coder", avatar: "https://i.pravatar.cc/150?img=28",
    text: "The food is amazing too, those pierogi at lunch were perfect", likes: 95, timestamp: "3h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c18", username: "devops_dude", avatar: "https://i.pravatar.cc/150?img=29",
    text: "Great insights on CI/CD for React Native apps", likes: 32, timestamp: "2h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c19", username: "dev_pioneer", avatar: "https://i.pravatar.cc/150?img=5",
    text: "Third year in a row, and App.js just keeps getting better", likes: 118, timestamp: "7h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c20", username: "mobile_dev_pro", avatar: "https://i.pravatar.cc/150?img=13",
    text: "Met so many amazing people in the hallway track today", likes: 56, timestamp: "4h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c21", username: "code_craftsman", avatar: "https://i.pravatar.cc/150?img=2",
    text: "The live coding demo was flawless, how do people do that without panicking", likes: 84, timestamp: "1h",
    replies: [
      { id: "first-c21-r1", username: "react_ninja", avatar: "https://i.pravatar.cc/150?img=4", text: "Practice. Lots of practice. And a backup recording just in case 😄", likes: 47, timestamp: "30m", replyingTo: "code_craftsman", replies: [] },
    ],
    sentiment: "positive", language: "en",
  },
  {
    id: "first-c22", username: "attendee_dev", avatar: "https://i.pravatar.cc/150?img=20",
    text: "Does anyone have notes from the accessibility talk? I was in the other room", likes: 23, timestamp: "2h",
    replies: [], sentiment: "neutral", language: "en",
  },
  {
    id: "first-c23", username: "type_wizard", avatar: "https://i.pravatar.cc/150?img=11",
    text: "TypeScript + Expo = the best DX I've ever had", likes: 69, timestamp: "3h",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c24", username: "animations_guru", avatar: "https://i.pravatar.cc/150?img=17",
    text: "See you all at the afterparty tonight! 🎉", likes: 134, timestamp: "30m",
    replies: [], sentiment: "positive", language: "en",
  },
  {
    id: "first-c25", username: "native_builder", avatar: "https://i.pravatar.cc/150?img=19",
    text: "Already counting down to App.js 2027", likes: 91, timestamp: "15m",
    replies: [], sentiment: "positive", language: "en",
  },
];
